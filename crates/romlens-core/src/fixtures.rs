...
/// A LoROM whose routines address the stack by offset, for the stack
/// locals and arguments (docs/22, L1):
///
/// ```text
...
pub fn stack_lorom() -> Vec<u8> {
    ...
    build_with_code(MappingMode::LoRom, 0x8000, false, &code, "STACK")
}
