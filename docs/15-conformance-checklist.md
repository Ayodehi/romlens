...
Written from `18-decompiler.md` on 23 September 2026. The macOS rows are built and covered by the app test bundle (🧪); the manual pass (steps 34–36) is still to run.
